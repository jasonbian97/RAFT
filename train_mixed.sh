#!/bin/bash
mkdir -p checkpoints
python -u train.py --name raft-chairs --stage chairs --validation chairs --restore_ckpt checkpoints/5000_raft-chairs.pth --gpus 4 --num_steps 120000 --batch_size 6 --lr 0.00025 --image_size 368 496 --wdecay 0.0001 --mixed_precision
